...
export class ProgramaAcademicoMateriaController {
  ...
  async find(
    ...
    return this.programaAcademicoRepository.materias(id).find(filter);
  }
  ...
  async create(
    ...
    return this.programaAcademicoRepository.materias(id).create(materia);
  }
  ...
  async patch(
    ...
    return this.programaAcademicoRepository.materias(id).patch(materia, where);
  }
  ...
  async delete(
    ...
    return this.programaAcademicoRepository.materias(id).delete(where);
  }
}
