// Creamos la relacion hasManyThrough desde grupo a usuario con intermedio usuarioGrupo
import {
  Count,
  CountSchema,
  Filter,
...
export class GrupoUsuarioController {
  ...
  @get('/grupos/{id}/usuarios', {
    responses: {
      '200': {
        description: 'Array of Grupo has many Usuario through UsarioGrupo',
        content: {
          'application/json': {
  ...
  async find(
    ...
    return this.grupoRepository.grupo(id).find(filter);
  }
  ...
  async create(
    ...
    return this.grupoRepository.grupo(id).create(usuario);
  }
  ...
  async patch(
    ...
    return this.grupoRepository.grupo(id).patch(usuario, where);
  }
  ...
  async delete(
    ...
    return this.grupoRepository.grupo(id).delete(where);
  }
}
